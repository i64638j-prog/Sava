...
class ExpenseTracker:
    ...
    def setup_ui(self):
        ...
        # Кнопки фильтрации
        ttk.Button(control_frame, text="Применить фильтр", command=self.apply_filter).grid(row=0, column=6, padx=5,
                                                                                           pady=5)
        ttk.Button(control_frame, text="Сбросить фильтр", command=self.reset_filter).grid(row=0, column=7, padx=5,
                                                                                          pady=5)
